...
from .views import TaskList, TaskDetail, TaskCreate, TaskUpdate, TaskDelete, HandleLogin, HandleRegistration
from django.contrib.auth.views import LogoutView

urlpatterns = [
    path('login/', HandleLogin.as_view(), name='login'),
    path('logout/', LogoutView.as_view(next_page='login'), name='logout'),
    path('register/', HandleRegistration.as_view(), name='register'),
